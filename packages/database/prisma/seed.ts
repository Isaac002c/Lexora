...
const rolePermissions: Record<RoleCode, PermissionCode[]> = {
  ...
  GESTOR_FILIAL: [
    ...
    "document.history", "finance.delete", "finance.restore", "finance.export", "finance.history", "audit.export",
  ...
  ADVOGADO: [
    ...
    "client.history", "case.delete", "case.restore", "case.export", "case.history", "deadline.delete", "deadline.restore",
    "deadline.export", "deadline.history", "document.delete", "document.restore", "document.history",
    "hearing.read", "hearing.create", "hearing.update", "hearing.delete", "hearing.restore", "hearing.export", "hearing.history",
    "task.read", "task.create", "task.update", "task.delete", "task.restore", "task.export", "task.history",
    "calendar.read", "calendar.create", "calendar.update", "calendar.delete", "calendar.restore",
  ],
  FINANCEIRO: ["dashboard.read", "client.read", "case.read", "finance.read", "finance.update", "report.read", "document.read", "document.upload", "client.history", "case.history", "document.delete", "document.restore", "document.history", "finance.delete", "finance.restore", "finance.export", "finance.history"],
  VISUALIZADOR: ["dashboard.read", "client.read", "attendance.read", "case.read", "deadline.read", "document.read", "finance.read", "report.read", "client.export", "client.history", "attendance.export", "attendance.history", "case.export", "case.history", "deadline.export", "deadline.history", "document.history", "finance.export", "finance.history", "hearing.read", "hearing.export", "hearing.history", "task.read", "task.export", "task.history", "calendar.read"],
};
...
const legalAreaSeeds = ["Trabalhista", "Criminal", "Cível", "Juizado Cível", "Vara Cível", "Federal", "Administrativo", "Previdenciário", "Família", "Imobiliário"];
