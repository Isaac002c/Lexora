...
export function ApiActionButton({ endpoint, body, label, confirmMessage, variant = "outline", method = "POST" }: { endpoint: string; body: Record<string, unknown>; label: string; confirmMessage?: string; variant?: "outline" | "default" | "ghost"; method?: "POST" | "PATCH" | "DELETE" }) {
